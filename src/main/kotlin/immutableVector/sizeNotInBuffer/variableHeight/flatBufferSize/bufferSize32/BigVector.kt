package immutableVector.sizeNotInBuffer.variableHeight.flatBufferSize.bufferSize32
...
internal class BigVector<T>(private val rest: Array<Any?>,
    ...
    override fun addLast(e: T): ImmutableVector<T> {
        ...
        val newLast = arrayOfNulls<Any?>(1) as Array<T>
        newLast[0] = e

        if (this.size shr LOG_MAX_BUFFER_SIZE > 1 shl this.shiftStart) {
            var newRest = arrayOfNulls<Any?>(2)
            newRest[0] = this.rest
